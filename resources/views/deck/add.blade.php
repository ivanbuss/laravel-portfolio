...
@section('content')
    ...
    <div class="container-fluid no-padding" id="addNewDeck">
        {!! Form::open(['action'=>['DeckEditController@postCreate'], 'id'=>'add-deck-form', 'class'=>'form-horizontal', 'role'=>'form', 'files' => true]) !!}
        <div class="header-add-deck">
            <div class="container">
                <div class="col-md-3{{ $errors->has('front_img') ? ' has-error' : '' }}">
                    <div id="front-deck-img-button" class="box-images">
                        <span class="box-images-description">FRONT BOX IMG</span>
                        <img src="/" class="front-deck-img-prev img-responsive">
                    </div>
                ...
                <div class="col-md-3{{ $errors->has('back_img') ? ' has-error' : '' }}">
                    <div id="back-deck-img-button" class="box-images">
                        <span class="box-images-description">BACK BOX IMG</span>
                        <img src="/" class="back-deck-img-prev img-responsive">
                    </div>
                    <p class="help-block">5mb size limit</p>
        ...
        <div class="main">
            <div class="container">
                <div class="col-md-12{{ $errors->has('description') ? ' has-error' : '' }}">
                    ...
                    {!! Form::textarea('description', old('description'), ['class'=>'form-control', 'placeholder'=>'Insert description here']) !!}
                ...
                <div class="col-md-6{{ $errors->has('company') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('company', old('company'), ['class'=>'form-control autocomplete-models']) !!}
                ...
                <div class="col-md-6{{ $errors->has('edition') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('edition', old('edition'), ['class'=>'form-control autocomplete-term']) !!}
                ...
                <div class="col-md-6{{ $errors->has('collection') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('collection', old('collection'), ['class'=>'form-control autocomplete-models']) !!}
                ...
                <div class="col-md-6{{ $errors->has('release_year') ? ' has-error' : '' }}">
                    ...
                    {{ Form::selectYear('release_year', (Carbon::now()->format('Y') - 150), (Carbon::now()->format('Y') + 10), old('release_year'), ['class'=>'form-control']) }}
                ...
                <div class="col-md-6{{ $errors->has('prod_run') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('prod_run', old('prod_run'), ['class'=>'form-control autocomplete-term']) !!}
            ...
            <div class="container">
                <div class="col-md-6{{ $errors->has('printer') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('printer', old('printer'), ['class'=>'form-control autocomplete-models']) !!}
                ...
                <div class="col-md-6{{ $errors->has('artist') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('artist', old('artist'), ['class'=>'form-control autocomplete-models']) !!}
                ...
                <div class="col-md-6{{ $errors->has('card_stock') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('card_stock', old('card_stock'), ['class'=>'form-control multiple autocomplete-term-multiple']) !!}
                ...
                <div class="col-md-6{{ $errors->has('finish') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('finish', old('finish'), ['class'=>'form-control autocomplete-term']) !!}
                ...
                <div class="col-md-6{{ $errors->has('court') ? ' has-error' : '' }}">
                    ...
                    {!! Form::select('court', ['Standard'=>'Standard', 'Modified'=>'Modified', 'Custom'=>'Custom'], old('court'), ['class'=>'form-control', 'placeholder' => '-Select-']) !!}
                ...
                <div class="col-md-6{{ $errors->has('features') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('features', old('features'), ['class'=>'form-control multiple autocomplete-term-multiple']) !!}
                ...
                <div class="col-md-6{{ $errors->has('colors') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('colors', old('colors'), ['class'=>'form-control multiple autocomplete-term-multiple']) !!}
                ...
                <div class="col-md-6{{ $errors->has('style') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('style', old('style'), ['class'=>'form-control multiple autocomplete-term-multiple']) !!}
                ...
                <div class="col-md-6{{ $errors->has('themes') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('themes', old('themes'), ['class'=>'form-control multiple autocomplete-term-multiple']) !!}
                ...
                <div class="col-md-6{{ $errors->has('tags') ? ' has-error' : '' }}">
                    ...
                    {!! Form::text('tags', old('tags'), ['class'=>'form-control multiple autocomplete-term-multiple']) !!}
