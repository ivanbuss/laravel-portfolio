...
@foreach($items as $item)
    <div rel="{{ $item->id }}" class="row list-item collection-list-item">
        <div href="#inline_content{{ $item->deck->id }}" class="col-lg-1 col-md-1 col-sm-6 col-xs-6 cboxElement group1">
            @if ($type == 'collection')
            ...
            @endif
            <a href="#"><img src="{{ $item->deck->getFrontImg('700x500') }}" class="img-responsive card-img front-img"></a>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
            <span class="deck-title">{{ $item->deck->name }}</span>
            <span class="edition">{{ $item->deck->edition}}</span>
        ...
        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
            <div id="animated-icons" class="animated-icons-small">
                <div class="collection-actions collection-deck-{{ $item->deck->id }} animated-icon-item{{ ((!$item->in_collection || $item->in_collection == 0) ? ' disabled' : '') }} col-lg-4 col-md-4 col-sm-4 col-xs-4">
                ...
                <div class="wishlist-actions collection-deck-{{ $item->deck->id }} animated-icon-item{{ ((!$item->in_wishlist || $item->in_wishlist == 0) ? ' disabled' : '') }} col-lg-4 col-md-4 col-sm-4 col-xs-4">
                ...
                <div class="tradelist-actions collection-deck-{{ $item->deck->id }} animated-icon-item{{ ((!$item->in_tradelist || $item->in_tradelist == 0) ? ' disabled' : '') }} col-lg-4 col-md-4 col-sm-4 col-xs-4">
