...
@section('content')
    ...
    <div class="red-bg user-collections-title">
        <div class="container">
            <div col-md-6>TRADELIST</div>
        </div>
    </div>
    <div class="container-fluid grey-bg">
        <div class="container">
            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                <h2>MY TRADELIST <span class="amount">({{ $count }})</span></h2>
            ...
            <div class="view-icons collections-view-icons discover-bar">
                ...
                <div class="container no-padding">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        {!! Form::open(['action'=>['TradelistController@postSearch', 'id'=>$user->id],'id'=>'search-form']) !!}
            ...
            <div rel="tradelist" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collection-list cards">
                <div id="collection-sortable" class="table-items" data-url="{{ action('TradelistController@postReorder') }}">
